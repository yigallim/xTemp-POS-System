...
export default function FoodCustomize({ api }) {
    ...
    const handleCustomizationChange = (id, value) => {
        const updatedCustomize = [
            ...selectedCustomization.filter(c => c.id !== id),
            { id, value }
        ];
    ...
    const totalPrice = () => {
        ...
        return (basePrice + customizationTotal + (takeaway ? foodCategory.takeawayCharge : 0)) * quantity;
    };
            ...
            <Row gutter={[0, 10]}>
                <Col span={24} className="border-b border-gray-300 bg-white">
                    ...
                    <div className="p-4 py-3">
                        ...
                        <div className="flex justify-between">
                            <div>
                                <p
                                    className="text-lg font-semibold py-0.5"
                ...
                {foodCategory.customize &&
                    foodCategory.customize.map((customization) => (
                        <Col
                            span={24}
                            className="border-y border-gray-300 bg-white"
                ...
                <Col span={24} className="border-y border-gray-300 bg-white">
                    ...
                    <div className="border-t border-gray-300 py-2 px-5 flex justify-between">
                        ...
                        <p className="text-slate-600">
                            + {foodCategory.takeawayCharge.toFixed(2)}
                        </p>
                    </div>
                </Col>
